...
export default function Service() {
  return (
    <div className=" text-white bg-[#0b133d] h-screen">
      <div className="container mx-auto">
        <h1 className="text-5xl font-bold pt-14 hover:text-blue-400">
          Our Services
        </h1>

        <div className="mt-12 p-4 grid grid-cols-3 gap-6 ">
          {data.map((service, index) => (
            ...
            >
              <div className="rounded-full bg-[#2751d8] p-2 w-20 h-20 border-4 border-white">
                <service.icon className="w-10 h-10 ml-2 mt-2" />
              </div>

              <span className="w-1 h-16 bg-white mt-2"></span>
              <div>
